...
Thanks for your interest in contributing to `@quonfig/cli`! Here are a few general guidelines
...
searching through our [issues list](https://github.com/quonfig/cli/issues).
...
We welcome anyone that wants to contribute to `@quonfig/cli` to triage and reply to open
...
Thanks again for your interest on contributing to `@quonfig/cli`!
