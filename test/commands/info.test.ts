    ...
    test
      ...
      .it('returns info for a name', (ctx) => {
        expect(ctx.stdout.trim()).to.eql(
          `
https://launch.goatsofquonfig.com/workspaces/workspace-123/flags/${keyWithEvaluations}
    ...
    test
      ...
      .it('returns JSON for a name', (ctx) => {
        ...
        expect(output[keyWithEvaluations].values).to.deep.equal({
          Default: {
            url: 'https://launch.goatsofquonfig.com/workspaces/workspace-123/flags/my-string-list-key?environment=undefined',
            value: ['a', 'b', 'c'],
          },
          Production: {
            url: 'https://launch.goatsofquonfig.com/workspaces/workspace-123/flags/my-string-list-key?environment=143',
          },
          jeffrey: {
            url: 'https://launch.goatsofquonfig.com/workspaces/workspace-123/flags/my-string-list-key?environment=588',
          },
        })
  ...
  describe('when there are no evaluations in the last 24 hours', () => {
    test
      ...
      .it('returns a message', (ctx) => {
        expect(ctx.stdout.trim()).to.eql(
          `
https://launch.goatsofquonfig.com/workspaces/workspace-123/flags/${keyWithNoEvaluations}
      ...
      .it('returns JSON', (ctx) => {
        expect(JSON.parse(ctx.stdout)).to.eql({
          [keyWithNoEvaluations]: {
            ...
            url: `https://launch.goatsofquonfig.com/workspaces/workspace-123/flags/${keyWithNoEvaluations}`,

            values: {
              Default: {
                url: 'https://launch.goatsofquonfig.com/workspaces/workspace-123/flags/jeffreys.test.key.reforge?environment=undefined',
                value: 'abc',
              },
              Production: {
                override: 'my.override',
                url: 'https://launch.goatsofquonfig.com/workspaces/workspace-123/flags/jeffreys.test.key.reforge?environment=143',
                value: '[see rules]',
              },

              jeffrey: {
                url: 'https://launch.goatsofquonfig.com/workspaces/workspace-123/flags/jeffreys.test.key.reforge?environment=588',
                value: '[see rules]',
              },
            },
          },
